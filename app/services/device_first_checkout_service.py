...
# (`device_first_payment_service.py:696-731`).
...
#     `late_paid_wallet_credit` (`device_first_payment_service.py:1987-1991`), либо уводят
#     заказ в `operator_review` с причиной удаления аккаунта (`:1821-1833`). То есть
