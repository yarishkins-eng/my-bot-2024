...
_PRESET_ROLES: list[dict] = [
    ...
    },
    {
        ...
        'permissions': [
            ...
            'landings:edit',
            'landings:delete',
            # Точечно, а не 'auto_messages:*': звёздочка выдала бы вперёд любой
            # будущий код этого раздела — включая тот, что шлёт сообщения людям.
            'auto_messages:read',
            'auto_messages:edit',
        ],
        'color': '#F59E0B',
    ...
    },
    {
        ...
        'permissions': [
            ...
            # 🔴 Досыпка прав односторонняя: снять это право правкой роли в кабинете не
            # выйдет, ближайший рестарт вернёт его. Отзыв — только правкой этого списка.
            'auto_messages:read',
            'auto_messages:edit',
        ],
        'color': '#8B5CF6',
