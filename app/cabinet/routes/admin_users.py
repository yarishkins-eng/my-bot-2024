...
# ОТЧ-7: определение «на пробном / платит» живёт в `app/utils/user_utils.py` и одно на два экрана —
# плитки кабинета и утреннее письмо владельцу. Имя с подчёркиванием оставлено ради тестов и вызова ниже.
_count_trial_and_paying_users = count_trial_and_paying_users
