...
class Settings(BaseSettings):
    ...
    # Gate 2 read-only shadow.  The independent kill switch defaults armed,
    # so accidentally enabling SHADOW alone still starts no worker.
    ENTITLEMENT_AUTHORITY_SHADOW_KILL_SWITCH: bool = True
    ENTITLEMENT_AUTHORITY_SHADOW_COHORT_BASIS_POINTS: int = 1000
    ENTITLEMENT_AUTHORITY_SHADOW_MAX_IDENTITIES_PER_CYCLE: int = 18
    ENTITLEMENT_AUTHORITY_SHADOW_SCHEDULE_SECONDS: int = 900
    ENTITLEMENT_AUTHORITY_SHADOW_PANEL_READS_PER_MINUTE: int = 12
    ENTITLEMENT_AUTHORITY_SHADOW_PANEL_TIMEOUT_SECONDS: float = 4.0
    ENTITLEMENT_AUTHORITY_SHADOW_DB_STATEMENT_TIMEOUT_MS: int = 5000
    ENTITLEMENT_AUTHORITY_SHADOW_MAX_CYCLE_SECONDS: float = 180.0
    ENTITLEMENT_AUTHORITY_SHADOW_MIN_RATIO_SAMPLE: int = 10
    ENTITLEMENT_AUTHORITY_SHADOW_MAX_PANEL_READ_ERRORS: int = 2
    ENTITLEMENT_AUTHORITY_SHADOW_MAX_PANEL_READ_ERROR_BASIS_POINTS: int = 1000
    ENTITLEMENT_AUTHORITY_SHADOW_MAX_MISSING_COUNT: int = 2
    ENTITLEMENT_AUTHORITY_SHADOW_MAX_MISSING_BASIS_POINTS: int = 1000
    ENTITLEMENT_AUTHORITY_SHADOW_MAX_CRITICAL_DRIFT_COUNT: int = 2
    ENTITLEMENT_AUTHORITY_SHADOW_MAX_CRITICAL_DRIFT_BASIS_POINTS: int = 1000
    ENTITLEMENT_AUTHORITY_SHADOW_MAX_TOTAL_DRIFT_COUNT: int = 4
    ENTITLEMENT_AUTHORITY_SHADOW_MAX_TOTAL_DRIFT_BASIS_POINTS: int = 2000
